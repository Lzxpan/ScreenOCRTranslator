...
API Key 申請教學：請看 [API_KEY_GUIDE.md](API_KEY_GUIDE.md)，內含 Gemini、Mistral Vision、Groq Llama4 的登入頁說明與登入後 API Keys 頁面截圖。<br>
...
新增 `API_KEY_GUIDE.md`，提供 Gemini、Mistral Vision、Groq Llama4 的登入頁面文字說明與登入後 API Keys 頁面截圖教學。<br>
